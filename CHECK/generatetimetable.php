...
<form action="generatetimetable.php" method="post">
    <div align="center" style="margin-top: 30px">
        ...
        <button type="submit" name="display" id="viewteacher" class="btn btn-success btn-lg" style="margin-top: 5px">VIEW TIMETABLE
        </button>
    </div>
</form>
<form action="generatetimetable.php" method="post">
                    ...
                    if (isset($_POST['select_semester'])) {
                        ...
                        while ($r = mysqli_fetch_assoc($qq)) {
                            if ($r['isalloted'] == 1 && $r['alloted01'] == $tid) {
                                ...
                                $str .= $r['c_id'] . ": " . $r['c_name'] . " <br>";
                            } else if ($r['isalloted'] == 1 && isset($r['alloted03']) && $r['alloted03'] == $tid) {
                                $str .= $r['c_id'] . ": " . $r['c_name'] . " <br>";
                            }
                        }
                    }
